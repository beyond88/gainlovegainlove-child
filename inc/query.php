...
function donation_query( $form_id, $per_page = NULL, $page_no = 1 ) {
    ...
    // return $sql = "SELECT a.donation_id, b.meta_value AS amount, c.meta_value AS first_name, d.meta_value AS last_name, e.meta_value AS email, f.meta_value AS donation_date, g.meta_value AS currency FROM ".$donation_meta_table." a 
    ...
    // AND a.meta_key = '_give_payment_form_id' AND a.meta_value = ".$form_id." ORDER BY amount DESC LIMIT ".$start.", ".$per_page."";
